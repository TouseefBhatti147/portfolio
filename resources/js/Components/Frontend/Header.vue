  ...
  >
    ...
    >
      <a href="#" class="flex items-center">
        <img src="/img/RMDPL-logo.png" class="mr-3 h-6 sm:h-9" alt="Description of my image">
        <span
          class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Royal Medicare Digital Pathology Lab</span
        >
      </a>
      <button
